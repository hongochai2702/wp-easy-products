<?php
	...
	if( !function_exists('wpeasy_enqueue_scripts') ){
		function wpeasy_enqueue_scripts(){
			...
			wp_register_style('wpeasy-animate', WPEASY_ASSETS_URL . '/css/animate.css');
			
			wp_register_script('wpeasy-main', WPEASY_ASSETS_URL . '/js/main.js');
			wp_register_script('wpeasy-layouts', WPEASY_ASSETS_URL . '/js/layouts.js', array('jquery'), '1.0.0', TRUE );
